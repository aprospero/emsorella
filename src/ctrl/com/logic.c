...
#define LGK_CIRC_NOM_TEMP      650 /* temperature where circulation is utilized */
#define LGK_CIRC_HYSTERESIS     80 /* degrees celsius difference between on and off state */
